...
/* 1 Назначаем переменную ***ColorExtract(равную изначально единице(тоесть равной следующему за дефолтным значению массива цветов))
   2 Каждый клик увеличивает значение ***ColorExtract на 1 (выбираем следующий цвет из массива)
   3 При достижении значения ***ColorExtract, равному количеству элементов массива(отсчёт от нуля),
   назначаем ***ColorExtract значение 0 (возвращаемся к первому элементу массива)*/
